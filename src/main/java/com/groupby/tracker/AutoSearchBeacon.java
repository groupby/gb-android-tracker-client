...
/**
 * autoSearch event sent directly from a native app client
 * <p>
 * An autoSearch event for the Android client type (as opposed to other client types like web browsers) sent directly from the client (as opposed to sent from a server serving the client). This event is used when the GroupBy search engine (as opposed to a non-GroupBy search engine) is used to power a product list page (PLP). Note that the only client officially supported for sending GroupBy this data is the official GroupBy native app SDK for the respective platform (Android, iOS, etc). A backwards incompatible change may be made to a major version of this schema if the change would not be backwards incompatible with respect to correct usage of the corresponding major version of the native app SDK.
 * 
 */
public class AutoSearchBeacon implements Parcelable
{
    ...
    public final static Creator<AutoSearchBeacon> CREATOR = new Creator<AutoSearchBeacon>() {


        @SuppressWarnings({
            "unchecked"
        })
        public AutoSearchBeacon createFromParcel(android.os.Parcel in) {
            return new AutoSearchBeacon(in);
        }

        public AutoSearchBeacon[] newArray(int size) {
            return (new AutoSearchBeacon[size]);
        }

    }
    ;

    protected AutoSearchBeacon(android.os.Parcel in) {
        this.event = ((AutoSearchEvent) in.readValue((AutoSearchEvent.class.getClassLoader())));
     ...
     * @param event
     */
    public AutoSearchBeacon(AutoSearchEvent event, List<Metadata> metadata, List<Experiments> experiments) {
        super();
        this.event = event;
     ...
     * 
     */
    public AutoSearchEvent getEvent() {
        return event;
    }
     ...
     * 
     */
    public void setEvent(AutoSearchEvent event) {
        this.event = event;
    }
    ...
    public String toString() {
        ...
        sb.append(AutoSearchBeacon.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("event");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AutoSearchBeacon) == false) {
            return false;
        }
        AutoSearchBeacon rhs = ((AutoSearchBeacon) other);
