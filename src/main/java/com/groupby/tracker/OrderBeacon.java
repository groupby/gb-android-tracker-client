...
public class OrderBeacon implements Parcelable
{
    ...
    public final static Creator<OrderBeacon> CREATOR = new Creator<OrderBeacon>() {


        @SuppressWarnings({
            "unchecked"
        })
        public OrderBeacon createFromParcel(android.os.Parcel in) {
            return new OrderBeacon(in);
        }

        public OrderBeacon[] newArray(int size) {
            return (new OrderBeacon[size]);
        }

    }
    ;

    protected OrderBeacon(android.os.Parcel in) {
        this.event = ((OrderEvent) in.readValue((OrderEvent.class.getClassLoader())));
     ...
     * @param event
     */
    public OrderBeacon(OrderEvent event, List<Metadata> metadata, List<Experiments> experiments) {
        super();
        this.event = event;
    ...
    public String toString() {
        ...
        sb.append(OrderBeacon.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("event");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OrderBeacon) == false) {
            return false;
        }
        OrderBeacon rhs = ((OrderBeacon) other);
