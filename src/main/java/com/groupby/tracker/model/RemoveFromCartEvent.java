 ...
 */
public class RemoveFromCartEvent implements Parcelable {
    ...
    public final static Creator<RemoveFromCartEvent> CREATOR = new Creator<RemoveFromCartEvent>() {

        public RemoveFromCartEvent createFromParcel(android.os.Parcel in) {
            return new RemoveFromCartEvent(in);
        }

        public RemoveFromCartEvent[] newArray(int size) {
            return (new RemoveFromCartEvent[size]);
        }

    };

    protected RemoveFromCartEvent(android.os.Parcel in) {
    ...
    public RemoveFromCartEvent(Cart cart) {
        this.cart = cart;
    }

    public RemoveFromCartEvent(Cart cart, String googleAttributionToken) {
        super();
        this.cart = cart;
    ...
    public String toString() {
        ...
        sb.append(RemoveFromCartEvent.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RemoveFromCartEvent) == false) {
            return false;
        }
        RemoveFromCartEvent rhs = ((RemoveFromCartEvent) other);
