...
/**
 * viewProduct event sent directly from a native app client
 * <p>
 * A viewProduct event for the native app client type (as opposed to other client types like web browsers) sent directly from the client (as opposed to sent from a server serving the client). This event is used when a shopper views details about a product on a native app screen. This use case is commonly referred to as PLP (product listing page). Note that the only client officially supported for sending GroupBy this data is the official GroupBy native app SDK for the respective platform (Android, iOS, etc). A backwards incompatible change may be made to a major version of this schema if the change would not be backwards incompatible with respect to correct usage of the corresponding major version of the native app SDK.
 */
public class ViewProductBeacon implements Parcelable {
    ...
    @Expose
    private ViewProductEvent event;
    /**
     * metadata component
     * <p>
    ...
    public final static Creator<ViewProductBeacon> CREATOR = new Creator<ViewProductBeacon>() {

        public ViewProductBeacon createFromParcel(android.os.Parcel in) {
            return new ViewProductBeacon(in);
        }

        public ViewProductBeacon[] newArray(int size) {
            return (new ViewProductBeacon[size]);
        }

    };

    protected ViewProductBeacon(android.os.Parcel in) {
        this.event = ((ViewProductEvent) in.readValue((ViewProductEvent.class.getClassLoader())));
     ...
     * @param event
     */
    public ViewProductBeacon(ViewProductEvent event, List<Metadata> metadata, List<Experiments> experiments) {
        super();
        this.event = event;
     ...
     * (Required)
     */
    public ViewProductEvent getEvent() {
        return event;
    }
     ...
     * (Required)
     */
    public void setEvent(ViewProductEvent event) {
        this.event = event;
    }
    ...
    public String toString() {
        ...
        sb.append(ViewProductBeacon.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("event");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ViewProductBeacon) == false) {
            return false;
        }
        ViewProductBeacon rhs = ((ViewProductBeacon) other);
