...
| Property | Description | Java type | Required? | Min | Max | String format |
| -------- | ----------- | --------- | --------- | --- | --- | ------------- |
| product | The product related to the cart item. | com.groupby.tracker.model.Product | Yes | n/a | n/a | n/a |
...
| Property | Description | Java type | Required? | Min | Max | String format |
| -------- | ----------- | --------- | --------- | --- | --- | ------------- |
| items | The cart items in the cart. | java.util.List<com.groupby.tracker.model.CartItem> | Yes | 1 | 1000 | n/a |
...
| cart | The cart related to the event. | com.groupby.tracker.model.Cart | Yes | n/a | n/a | n/a |
