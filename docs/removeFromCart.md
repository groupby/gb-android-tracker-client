...
| -------- | ----------- | --------- | --------- | --- | --- | ------------- |
| actual | The price the customer would pay for the product if they had proceeded to order it instead of removing it from their cart. | `String` | Yes | n/a | 100 | ^[0-9]{1,9}\\.?[0-9]{1,2}$ |
...
| onSale | Whether the product was on sale when the shopper removed it from their cart. | `Boolean` | Yes | n/a | n/a | n/a |
...
| quantity | The quantity of the product being removed from the cart. | `Integer` | Yes | 1 | 2147483647 | n/a |

Cart:

| Property | Description | Java type | Required? | Min | Max | String format |
| -------- | ----------- | --------- | --------- | --- | --- | ------------- |
| items | The cart items being removed from the cart. | `List<CartItem>` | Yes | 1 | 1000 | n/a |
...
| Property | Description | Java type | Required? | Min | Max | String format |
| -------- | ----------- | --------- | --------- | --- | --- | ------------- |
| event | The event data for the beacon. | `RemoveFromCartEvent` | Yes | n/a | n/a | n/a |
